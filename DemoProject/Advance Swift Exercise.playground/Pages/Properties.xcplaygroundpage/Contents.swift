...
class LazyStored {
    ...
    var property: String
    lazy var lazyProperty: () = {
        print("property name is: \(self.property)")
    }()
...
var lazyStore = LazyStored(property: "Lazy Property")
lazyStore.lazyProperty

// Ans

// property name is: Lazy Property
